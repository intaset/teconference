...
Thank you for registering for ICTE 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us the final version of your paper and a signed copyright form via email to info@teconference.com. You can find the copyright form here: www.2019.teconference.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: http://2019.teconference.com/accommodation/#Novotel
...
$your_subject = "Your Registration Details for ICTE'19";

$your_headers = "From: ICTE'19 <" . $my_email . ">";
...
<title>ICTE'19 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>4<sup>th</sup> International Conference on<br>Traffic Engineering (ICTE'19)</h1>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICTE'19!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICTE'19, please fill out the form below:</p>
